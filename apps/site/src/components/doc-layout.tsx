...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { to: '/docs/guides/broadcast', label: '@roost/broadcast' },
      { to: '/docs/guides/events', label: '@roost/events' },
      { to: '/docs/guides/feature-flags', label: '@roost/feature-flags' },
      { to: '/docs/guides/mcp', label: '@roost/mcp' },
      { to: '/docs/guides/billing', label: '@roost/billing' },
      { to: '/docs/guides/queue', label: '@roost/queue' },
      { to: '/docs/guides/workflow', label: '@roost/workflow' },
  ...
  },
  {
    ...
    links: [
      ...
      { to: '/docs/reference/broadcast', label: '@roost/broadcast' },
      { to: '/docs/reference/events', label: '@roost/events' },
      { to: '/docs/reference/feature-flags', label: '@roost/feature-flags' },
      ...
      { to: '/docs/reference/workflow', label: '@roost/workflow' },
  ...
  },
  {
    ...
    links: [
      ...
      { to: '/docs/concepts/broadcast', label: '@roost/broadcast' },
      { to: '/docs/concepts/events', label: '@roost/events' },
      { to: '/docs/concepts/feature-flags', label: '@roost/feature-flags' },
      { to: '/docs/concepts/mcp', label: '@roost/mcp' },
      { to: '/docs/concepts/billing', label: '@roost/billing' },
      { to: '/docs/concepts/queue', label: '@roost/queue' },
      { to: '/docs/concepts/workflow', label: '@roost/workflow' },
