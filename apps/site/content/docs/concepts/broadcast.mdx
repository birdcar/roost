...
- [@roostjs/broadcast reference — Channel, ChannelDO, BroadcastManager, and client API](/docs/reference/broadcast)
- [@roostjs/events concepts — How events and broadcast connect](/docs/concepts/events)
