...
Roost's `@roostjs/cloudflare` package wraps these raw binding objects with typed,
...
- [@roostjs/cloudflare concepts — the binding wrapper design](/docs/concepts/cloudflare)
