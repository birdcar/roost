...
- [@roostjs/events reference — Event, EventDispatcher, Listener, Subscriber API](/docs/reference/events)
- [@roostjs/broadcast concepts — How broadcast and events connect](/docs/concepts/broadcast)
- [@roostjs/queue concepts — When to use ShouldQueue](/docs/concepts/queue)
