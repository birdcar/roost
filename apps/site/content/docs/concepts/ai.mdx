...
- [@roostjs/cloudflare concepts — AIClient and the Workers AI binding](/docs/concepts/cloudflare)
- [@roostjs/mcp concepts — how MCP tools relate to AI agent tools](/docs/concepts/mcp)
- [@roostjs/schema concepts — how tool schemas are defined](/docs/concepts/schema)
- [@roostjs/ai reference — Agent, Tool, and decorator API](/docs/packages/ai)
