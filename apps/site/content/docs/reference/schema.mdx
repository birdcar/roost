---
title: "@roost/schema"
description: Fluent JSON Schema builder with zero runtime dependencies. Used by @roost/ai and @roost/mcp to define tool and prompt parameters.
---

## Installation

```bash title="terminal"
bun add @roost/schema
```
