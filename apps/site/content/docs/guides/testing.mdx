...
import { TestClient } from '@roostjs/testing';
...
import { TestClient, fakeAll, restoreAll } from '@roostjs/testing';
import { SendWelcomeEmail } from '../src/jobs/SendWelcomeEmail';
import { BillingFake } from '@roostjs/billing';
...
```ts
import { createTestApp } from '@roostjs/testing';
import { TestClient } from '@roostjs/testing';
