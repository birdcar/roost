---
title: "@roostjs/schema Guides"
description: Task-oriented instructions for defining tool input schemas, optional fields, nested objects, and descriptions.
---
